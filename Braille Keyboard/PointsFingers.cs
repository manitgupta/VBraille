...
namespace BrailleKeyboard
{
    public class PointsFingers
    {
        ...
        /// Point (0, 0)
        /// </summary>
        public static PointsFingers Zero { get { return new PointsFingers(0, 0); } }
        /// <summary>
        /// Point (1, 1)
        /// </summary>
        public static PointsFingers One { get { return new PointsFingers(1, 1); } }

        /// <summary>
        /// Initializes a new instance of PointFT with every variable equals to 0.
        /// </summary>
        public PointsFingers()
        {
            this.X = 0;
            this.Y = 0;
        }
        ...
        public PointsFingers(int X, int Y)
        {
            this.X = X;
            this.Y = Y;
        }
        ...
        public static bool operator !=(PointsFingers point1, PointsFingers point2)
        {
